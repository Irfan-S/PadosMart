...
class ShopBase : AppCompatActivity(), Toolbar.OnMenuItemClickListener, View.OnClickListener {

    private val TAG = "ShopBase"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val toolbar = findViewById<MaterialToolbar>(R.id.shopHomeAppBar)
